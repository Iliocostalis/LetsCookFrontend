...
/**
 * Own Request to POST a new Recipe
 */
public class PostRecipeRequest extends RecipeRequest
{

    public PostRecipeRequest(String url, Recipe recipe, Response.Listener<RecipeResponse> listener)
    {
        super(Method.POST, url, recipe, listener);
    }
